...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-black text-white px-6 py-10">
      ...
      {/* HOW IT WORKS */}
      <div className="max-w-3xl mx-auto mt-12 text-center text-gray-300">
      ...
      <div className="max-w-xl mx-auto mt-12 bg-zinc-900 p-6 rounded-2xl border border-green-500 shadow-lg">
        ...
        <input
          ...
          className="w-full p-3 mb-3 rounded bg-black border border-green-500 focus:outline-none"
        />
        ...
        {/* FILE UPLOAD */}
        <label className="block border-2 border-dashed border-green-500 p-4 text-center rounded cursor-pointer mb-3">
